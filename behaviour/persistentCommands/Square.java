...
public class Square extends Leaf {
    ...
    public boolean isValid() {
        return API.mode == API.modes.SQUARE;
    }
    ...
    public int onLoop() {		
		...
		if(followID.isEmpty())
		{
			MethodProvider.log("square target: " + API.callerName + " not found! Waiting...");
		...
		{
			MethodProvider.log("square target left! Exiting square...");
			API.exitstop();
